    ...
    for relation in relations:
        ...
        with concurrent.futures.ProcessPoolExecutor() as executor:
            ...
            function_args = [
                ...
                (relation, "AC", True, project_name),
                (relation, "PPO", True, project_name),
            ]

            # 提交函数到进程池
            futures = [executor.submit(run_single_method, *args) for args in function_args]
            # 实际上等价于
        ...
        csv_filename = f"compare_result.csv"
        csv_filename = os.path.join(os.path.dirname(__file__), "log", csv_filename)
        csv_header = ["relation", "RL", "AC", "PPO"]
