...
def fact_prediction_single(mode="PPO", relation="concept_agentbelongstoorganization",dataset_name="NELL-995"):
...
if __name__ == "__main__":
    ...
    for relation in relations:
        ...
        fact_prediction_single(mode=mode, relation=relation)
