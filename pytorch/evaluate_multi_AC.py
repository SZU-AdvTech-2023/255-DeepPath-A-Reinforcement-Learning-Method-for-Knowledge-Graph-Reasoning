...
from utils import relations, dataPath,get_path_stats_path,get_path_to_use_path
import os
...
def evaluate_single(relation, dataset="NELL-995",mode = "AC"):
